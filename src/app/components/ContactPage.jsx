...
export default function ContactPage() {
  ...
  padding-left: 56px;
        ...
        .cp-help-title span.icon { font-size: 16px; }
        .cp-help-body {
          font-size: 12.5px;
          color: #444;
          line-height: 1.65;
        ...
        .cp-wa:hover { background: #1ebe59; transform: scale(1.04); }
        .cp-wa svg { font-size: 22px; }
  ...
  .cp-right {
    ...
    padding-left: 0;
        ...
        @media (max-width: 600px) {
          ...
          .cp-wa { width: 120px; height: 48px; right: 14px; bottom: 14px; font-size: 13px; }
        }
      `}</style>
